...
if __name__ == "__main__":
    ...
    for template in templates.keys():
        ...
        if res:
            ...
            logLine(f"+{tProcess:.2f}s Processed: {totalReq-totalOut}/{totalReq} - Ratio: {(counters["valid"]/counters["total"])*100:2.0f}%S {vToksRatio*100:2.0f}%T - {vSampleRate:.0f}sams {vToksRate:.0f}toks")
            logLine("Counters:")
